...
using System.Text;
using WGL.Account.Application;
using WGL.Account.Domain.Settings;
using WGL.Account.Extensions;
using WGL.Account.Persistence;

namespace WGL.Account
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "WGL.Account", Version = "v1" });
